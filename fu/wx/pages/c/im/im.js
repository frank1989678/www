var strophe = require('../../../lib/im/strophe.js')
var WebIM = require('../../../lib/im/WebIM.js')
...
Page({
	...
	onLoad: function(options) {
		...
		var num = wx.getStorageSync(name + myName).length - 1;
		if (num > 0) {
			setTimeout(function() {
				that.setData({
					toView: wx.getStorageSync(name + myName)[num].mid
				})
			}, 10)
		}
		this.setData({
