<template>
	<div class="setting">
		...
		<div class="form">
			...
			<mt-button type="primary" size="large" class="mt" v-on:click="onSaveSettingForm">保存</mt-button>
		</div>
...
export default{
	...
	methods: {
	    ...
	    onOpenPciceDialog: function() {
	    	const that = this;
	    	MessageBox.prompt('价格', '', {
	    		inputType: 'number', 
	    		// inputValue: that.form.price,
	    ...
	    // 保存设置
	    onSaveSettingForm: function() {
	    	const that = this;
	    	const params = this.form;
	    	axios.post('./static/json/orderset.json', params)
			  .then(res => {
...
.form .trigger{position:absolute;top:0;left:0;right:0;bottom:0;text-align:right;z-index:9999;}
