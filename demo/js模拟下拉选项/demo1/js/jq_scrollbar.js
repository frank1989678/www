		...
		scrolling: function(i, q, n, k, A, f, D, w) {
			...
			if (!l.data("bindEvent_scrollbar_drag")) {
				...
				if (c.support.pointer || c.support.msPointer) {
					...
					c(document).bind(z + "." + l.data("mCustomScrollbarIndex"),
					function(K) {
						K.preventDefault();
						if (l.data("on_drag")) {
							var J = k,
					...
					}).bind(e + "." + l.data("mCustomScrollbarIndex"),
					function(x) {
						l.data({
							on_drag: false
						});
					...
					c(document).bind("mousemove." + l.data("mCustomScrollbarIndex"),
					function(K) {
						if (l.data("on_drag")) {
							var J = k,
							M = J.offset(),
					...
					}).bind("mouseup." + l.data("mCustomScrollbarIndex"),
					function(x) {
						l.data({
							on_drag: false
						});
				...
				if (l.data("scrollButtons_scrollType") === "pixels") {
					...
					if (l.data("horizontalScroll")) {
						...
						if (!l.data("bindEvent_buttonsContinuous_x")) {
							...
							D.bind("mousedown touchstart MSPointerDown pointerdown",
							function(y) {
								y.preventDefault();
								var x = B();
								l.data({
						...
						if (!l.data("bindEvent_buttonsContinuous_y")) {
							f.bind("mousedown touchstart MSPointerDown pointerdown",
							function(y) {
								y.preventDefault();
								var x = B();
								l.data({
							...
							A.bind("mousedown touchstart MSPointerDown pointerdown",
							function(y) {
								y.preventDefault();
								var x = B();
								l.data({
