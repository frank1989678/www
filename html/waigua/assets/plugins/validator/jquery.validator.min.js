...
(function(factory) {
    ...
    $.validator.config({
        ...
        rules: {
            ...
            ,password: [/^[a-zA-Z0-9]{1,20}$/, "长度为1-20位的字母、数字"]
            ,company: [/^([a-zA-Z0-9_\(\)-]|[\u4e00-\u9fa5]|[（）]){4,50}$/, "企业名称长度4-50，只能由中英文、数字及\"_\"、\"-\"、()、（）组成"]
            ,nickName: [/^([a-zA-Z]|[\u4e00-\u9fa5]){2,50}$/, "联系人姓名长度2-50位，只能包括中文字、英文字母"]
            ,money: [/^(([1-9]\d{0,9})|0)(\.\d{1,2})?$/, "整数部位最多8为，小数部位最多2位"]
            ,bankNumber: [/^\d{12,19}$/, '银行卡号是12-19位数字']
            ,age: [/18|19|(^[2-9]\d$)/, '请填写有效的年龄']
            ,ip: [/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i, 'IP无效']
