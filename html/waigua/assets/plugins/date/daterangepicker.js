    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function getLanguages() {
            if (opt.language == 'auto') {
                ...
                if (!language) {
                    return $.dateRangePickerLanguages['zh'];
                }
        ...
        function translate(translationKey) {
            ...
            var defaultLanguage = $.dateRangePickerLanguages['zh'];
...
!(function($) {
    $.fn.date = function(options) {
        var time = false,
            options = options || {};
        if (options.time1 == undefined && options.time2 == undefined) {
            return;
        }
        if (options.format) {
            time = options.format.indexOf('HH:mm') > -1;
        }
        var defaults = {
            format: 'YYYY-MM-DD',
            isinitVal: false,
            ...
            setValue: function(s,s1,s2){
                $(options.time1).val(s1);
                $(options.time2).val(s2);
            }
        }
