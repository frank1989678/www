...
;(function(root, factory) {
    ...
    jedfn.generateHtml = function(opts,boxCell){
        ...
        var botStrHtml = '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><input type="text" maxlength="2" numval="23" hms="0"></li><i>:</i><li><input type="text" maxlength="2" numval="59" hms="1"></li><i>:</i><li><input type="text" maxlength="2" numval="59" hms="2"></li></ul></div>' +
            '<div class="botflex jedatebtn"><span class="jedateok jebtn2">'+lang.yes+'</span><span class="jedatetodaymonth jebtn2">'+lang.today+'</span><span class="jedateclear jebtn2">'+lang.clear+'</span></div>';

        var ymBtnHtml = '<p><span class="jedateymchle jebtn1">&lt;&lt;</span><span class="jedateymchri jebtn1">&gt;&gt;</span><span class="jedateymchok jebtn2">'+lang.close+'</span></p>';
        //设置html到对应的DOM中
        if (subhh){
    ...
    jedfn.chooseDays = function(opts,boxCell) {
        ...
        if(opts.festival && lang.name == "cn") {
            //鼠标进入提示框出现
            boxCell.find(".jedaul li").on("mouseenter", function () {
            ...
            }).on( "mouseleave", function () { //鼠标移除提示框消失
                if($("#jedatetipscon").length > 0) $("#jedatetipscon").remove();
            });
        }
    };
